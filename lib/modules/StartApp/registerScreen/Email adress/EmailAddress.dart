...
import 'package:hayat/modules/StartApp/registerScreen/emailVerification/emailVervicationScreen.dart';
                                ...
                                builder:(context) =>   defaultButton(
                                    ...
                                    onTap: (){
                                      if(formKey.currentState!.validate()){
                                        NavegateTo(context ,EmailverificationScreen());
